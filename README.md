...
crusher-cli/1.2.0 darwin-x64 node-v10.20.1
...
_See code: [src/commands/run.ts](https://github.com/crusherdev/CLI/blob/v1.2.0/src/commands/run.ts)_
...
_See code: [src/commands/setup.ts](https://github.com/crusherdev/CLI/blob/v1.2.0/src/commands/setup.ts)_
<!-- commandsstop -->
