...
crusher-cli/1.3.13 darwin-x64 node-v10.20.1
...
_See code: [src/commands/run.ts](https://github.com/crusherdev/CLI/blob/v1.3.13/src/commands/run.ts)_
...
_See code: [src/commands/setup.ts](https://github.com/crusherdev/CLI/blob/v1.3.13/src/commands/setup.ts)_
<!-- commandsstop -->
