...
describe("Test create command", () => {
	...
	it("should throw error if not logged in", async () => {
		mock.onGet("https://backend.crusher.dev/cli/get.key").reply(200, { loginKey: "xyzyzyzyzyzy" });
	...
	it("should request user info", async () => {
		mock.onGet("https://backend.crusher.dev/users/actions/getUserAndSystemInfo").reply(200, {
			userId: "275",
			isUserLoggedIn: true,
			userData: {
				userId: "275",
